...
const createReactComponent = (iconName, iconNode)=>{
    const Component = /*#__PURE__*/ (0,react_shared_subset.forwardRef)(({ color = "currentColor", size = 24, strokeWidth = 2, children, ...rest }, ref)=>/*#__PURE__*/ (0,react_shared_subset.createElement)("svg", {
            ref,
            ...defaultAttributes,
            width: size,
            height: size,
