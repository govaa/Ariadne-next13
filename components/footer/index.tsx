...
import EmailSignUp from "@/components/email-newsletter";
...
const Footer = () => {
  ...
  return (
    <footer>
      <EmailSignUp/>
      <div className="flex items-center justify-center border-b-1 border-neutral-200 p-6 dark:border-neutral-500">
    ...
    <div className="bg-ariadneblue text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-">
