...
var __exports__ = (() => {
  ...
  var require_moment = __commonJS({
    "../../node_modules/moment/moment.js"(exports, module) {
      (function(global, factory) {
        ...
        function substituteTimeAgo(string, number3, withoutSuffix, isFuture, locale3) {
          return locale3.relativeTime(number3 || 1, !!withoutSuffix, string, isFuture);
        }
  ...
  var require_moment_timezone = __commonJS({
    "../../node_modules/moment-timezone/moment-timezone.js"(exports, module) {
      (function(root, factory) {
        ...
        var VERSION4 = "0.5.35", zones = {}, links = {}, countries = {}, names = {}, guesses = {}, cachedGuess;
  ...
  // external-global-plugin:@deck.gl/aggregation-layers
  var require_aggregation_layers = __commonJS({
    "external-global-plugin:@deck.gl/aggregation-layers"(exports, module) {
      module.exports = globalThis.deck;
    }
  });
  ...
  var require_tile_cover = __commonJS({
    "../../node_modules/@mapbox/tile-cover/index.js"(exports) {
      ...
      function mergeTiles(tileHash, tiles2, limits) {
        ...
        for (var z = limits.max_zoom; z > limits.min_zoom; z--) {
          ...
          for (var i = 0; i < tiles2.length; i++) {
            var t = tiles2[i];
            if (t[0] % 2 === 0 && t[1] % 2 === 0) {
              var id22 = toID(t[0] + 1, t[1], z), id32 = toID(t[0], t[1] + 1, z), id4 = toID(t[0] + 1, t[1] + 1, z);
      ...
      function fromID(id4) {
        var z = id4 % 32, dim = 2 * (1 << z), xy = (id4 - z) / 32, x = xy % dim, y = (xy - x) / dim % dim;
        return [x, y, z];
      }
    }
  });
  ...
  __export(src_exports, {
    ...
    _CartoTileLayer: () => CartoTileLayer,
    _H3TileLayer: () => H3TileLayer,
    _PointLabelLayer: () => PointLabelLayer,
    _QuadbinTileLayer: () => QuadbinTileLayer,
    _RasterTileLayer: () => RasterTileLayer,
    _getDataV2: () => getDataV2,
    _mapInstantiation: () => mapInstantiation,
    colorBins: () => colorBins,
  ...
  // src/layers/carto-layer.ts
  var import_core11 = __toESM(require_core());
  var import_geo_layers8 = __toESM(require_geo_layers());
...
${formatErrorKey(key)}: ${errorContext[key]}`;
  ...
  async function getDataV2({
    ...
    const apiVersion = credentials2?.apiVersion || defaultCredentials.apiVersion;
    const localCreds = {
    ...
    switch (apiVersion) {
      ...
      default:
        throw new Error(`Invalid maps API version. It should be ${API_VERSIONS.V1} or ${API_VERSIONS.V2}`);
    }
  }
  ...
  function dealWithError({
    ...
    switch (response.status) {
      case 401:
        throw new Error(`Unauthorized access to Maps API: invalid combination of user ('${credentials2.username}') and apiKey ('${credentials2.apiKey}')`);
      case 403:
        throw new Error(`Unauthorized access to dataset: the provided apiKey('${credentials2.apiKey}') doesn't provide access to the requested data`);
      default:
        const e = credentials2.apiVersion === API_VERSIONS.V1 ? JSON.stringify(json.errors) : json.error;
        throw new Error(e);
    }
  }
  ...
  function buildURLMapsAPIv1({
    ...
    const parameters = initURLParameters(credentials2);
    const cfg = JSON.stringify(mapConfig);
    return `${mapsUrl(credentials2)}?${parameters.join("&")}&${encodeParameter("config", cfg)}`;
  }
  function buildURLMapsAPIv2({
    ...
    let url = `${mapsUrl(credentials2)}/${connection}/${mapsApiType}?`;
  ...
  function transformer() {
    var domain = unit, range2 = unit, interpolate = value_default, transform, untransform, unknown, clamp2 = identity2, piecewise, output, input;
    function rescale() {
  ...
  // src/api/layer-map.ts
  var import_moment_timezone = __toESM(require_moment_timezone2());
  var import_aggregation_layers = __toESM(require_aggregation_layers());
  var import_layers3 = __toESM(require_layers());
  var import_geo_layers7 = __toESM(require_geo_layers());

  // src/layers/carto-tile-layer.ts
  ...
  var import_geo_layers = __toESM(require_geo_layers());
  ...
  // src/layers/carto-tile-layer.ts
  (0, import_core2.registerLoaders)([carto_vector_tile_loader_default]);
  var defaultTileFormat = TILE_FORMATS.BINARY;
  var defaultProps = {
    ...import_geo_layers.MVTLayer.defaultProps,
    formatTiles: defaultTileFormat
  };
  var CartoTileLayer = class extends import_geo_layers.MVTLayer {
    initializeState() {
    ...
    getTileData(tile) {
      const url = (0, import_geo_layers._getURLFromTemplate)(this.state.data, tile);
      if (!url) {
    ...
    renderSubLayers(props) {
      ...
      const subLayer = new import_layers.GeoJsonLayer(subLayerProps);
      return subLayer;
    }
  ...
  __publicField(CartoTileLayer, "layerName", "CartoTileLayer");
  __publicField(CartoTileLayer, "defaultProps", defaultProps);

  // src/layers/h3-tile-layer.ts
  var import_core4 = __toESM(require_core());
  var import_geo_layers4 = __toESM(require_geo_layers());

  // src/layers/h3-tileset-2d.ts
  var import_geo_layers2 = __toESM(require_geo_layers());
  ...
  function getHexagonsInBoundingBox({
    ...
    const oversample = 2;
    const h3Indices = (0, import_h3_js.polyfill)([[[west, north], [west, south], [east, south], [east, north], [west, north]]], resolution + oversample, true);
    return oversample ? [...new Set(h3Indices.map((i) => (0, import_h3_js.h3ToParent)(i, resolution)))] : h3Indices;
  }
  function tileToBoundingBox(index) {
    const coordinates = (0, import_h3_js.h3ToGeoBoundary)(index);
  ...
  var H3Tileset2D = class extends import_geo_layers2._Tileset2D {
    getTileIndices({
      ...
      if (typeof maxZoom === "number" && Number.isFinite(maxZoom) && z > maxZoom) {
        z = maxZoom;
        const center = (0, import_h3_js.geoToH3)(viewport.latitude, viewport.longitude, maxZoom);
        indices = (0, import_h3_js.kRing)(center, 1);
      } else {
    ...
    getTileZoom({
      ...
      return (0, import_h3_js.h3GetResolution)(i);
    }
    getParentIndex(index) {
      const resolution = (0, import_h3_js.h3GetResolution)(index.i);
      const i = (0, import_h3_js.h3ToParent)(index.i, resolution - 1);
      return {
        i
      };
    }
  ...
  var TileReader2 = class {
    static read(pbf, end) {
      return pbf.readFields(TileReader2._readField, {
        blockWidth: 0,
        blockHeight: 0,
        bands: []
      }, end);
  ...
  var TileReader3 = class {
    static read(pbf, end) {
      return pbf.readFields(TileReader3._readField, {
        scheme: 0,
        cells: null
      }, end);
    }
  ...
  function binaryToSpatialjson(binary) {
    ...
    for (let i = 0; i < count; i++) {
      const id4 = scheme === "h3" ? bigIntToHex(cells.indices.value[i]) : cells.indices.value[i];
      const properties = {
        ...cells.properties[i]
      };
  ...
  // src/layers/spatial-index-tile-layer.ts
  var import_geo_layers3 = __toESM(require_geo_layers());
  (0, import_core3.registerLoaders)([carto_raster_tile_loader_default, carto_spatial_tile_loader_default]);
  ...
  var SpatialIndexTileLayer = class extends import_geo_layers3.TileLayer {
    updateState(params) {
      const {
        props,
        oldProps
  ...
  __publicField(SpatialIndexTileLayer, "layerName", "SpatialIndexTileLayer");
  __publicField(SpatialIndexTileLayer, "defaultProps", defaultProps2);
  ...
  var renderSubLayers = (props) => {
    ...
    if (!data || !data.length)
      return null;
    return new import_geo_layers4.H3HexagonLayer(props, {
      getHexagon: (d) => d.id,
      centerHexagon: index,
      highPrecision: true
    });
  ...
  var H3TileLayer = class extends import_core4.CompositeLayer {
    initializeState() {
      import_geo_layers4.H3HexagonLayer._checkH3Lib();
      this.setState({
        data: null,
        tileJSON: null
      });
  ...
  __publicField(H3TileLayer, "layerName", "H3TileLayer");
  __publicField(H3TileLayer, "defaultProps", defaultProps3);

  // src/layers/quadbin-tile-layer.ts
  var import_core5 = __toESM(require_core());

  // src/layers/quadbin-layer.ts
  var import_geo_layers5 = __toESM(require_geo_layers());
  ...
  var QuadbinLayer = class extends import_geo_layers5._GeoCellLayer {
    indexToBounds() {
      const {
        data,
        extruded,
  ...
  __publicField(QuadbinLayer, "layerName", "QuadbinLayer");
  __publicField(QuadbinLayer, "defaultProps", defaultProps4);

  // src/layers/quadbin-tileset-2d.ts
  var import_geo_layers6 = __toESM(require_geo_layers());
  var QuadbinTileset2D = class extends import_geo_layers6._Tileset2D {
    getTileIndices(opts) {
  ...
  var QuadbinTileLayer = class extends import_core5.CompositeLayer {
    initializeState() {
      this.setState({
        data: null,
        tileJSON: null
  ...
  __publicField(QuadbinTileLayer, "layerName", "QuadbinTileLayer");
  __publicField(QuadbinTileLayer, "defaultProps", defaultProps5);
...
`;
  ...
  var RasterColumnLayer = class extends import_layers2.ColumnLayer {
    getShaders() {
  ...
  __publicField(RasterColumnLayer, "layerName", "RasterColumnLayer");
  var RasterLayer = class extends import_core6.CompositeLayer {
    renderLayers() {
      const {
        data,
        getElevation,
      ...
      assert(blockWidth === blockHeight, `blockWidth (${blockWidth}) must equal blockHeight (${blockHeight})`);
  ...
  __publicField(RasterLayer, "defaultProps", defaultProps6);
  ...
  var RasterTileLayer = class extends import_core7.CompositeLayer {
    initializeState() {
      this.setState({
        data: null,
        tileJSON: null
  ...
  __publicField(RasterTileLayer, "layerName", "RasterTileLayer");
  __publicField(RasterTileLayer, "defaultProps", {});
  ...
  function getLayer(type, config, dataset) {
    ...
    const layerTypeDefs = {
      point: {
        Layer: import_layers3.GeoJsonLayer,
        propMap: {
          columns: {
            altitude: (x) => ({
              parameters: {
  ...
  function layerFromTileDataset(formatTiles = TILE_FORMATS.MVT, scheme, type) {
    ...
    if (formatTiles === "mvt") {
      return import_geo_layers7.MVTLayer;
    }
  ...
  function getSizeAccessor({
    ...
    const scale = scaleType ? SCALE_FUNCS[scaleType]() : identity3;
    if (scaleType) {
  ...
  function getTextAccessor({
    ...
    const format2 = FORMATS2[type] || FORMATS2.default;
    const accessor = (properties) => {
  ...
  var EnhancedTextBackgroundLayer = class extends import_layers4._TextBackgroundLayer {
    getShaders() {
      const shaders = super.getShaders();
      let vs = shaders.vs;
  ...
  __publicField(EnhancedTextBackgroundLayer, "layerName", "EnhancedTextBackgroundLayer");
  var EnhancedTextLayer = class extends import_layers4.TextLayer {
    filterSubLayer({
      layer,
      renderPass
    }) {
  ...
  __publicField(EnhancedTextLayer, "layerName", "EnhancedTextLayer");
  var defaultProps8 = {
    ...import_layers4.TextLayer.defaultProps,
    getRadius: {
      type: "accessor",
      value: 1
    },
  ...
  var PointLabelLayer = class extends import_core8.CompositeLayer {
  ...
  __publicField(PointLabelLayer, "layerName", "PointLabelLayer");
  __publicField(PointLabelLayer, "defaultProps", defaultProps8);

  // src/api/parseMap.ts
  var import_core9 = __toESM(require_core());
  var import_extensions2 = __toESM(require_extensions());
    ...
    return {
      ...
      layers: layers.reverse().map(({
        ...
        try {
          ...
          import_core9.log.error(e.message)();
          return void 0;
        }
      })
    };
  ...
  function createParametersProp(layerBlending, parameters) {
    if (layerBlending === "additive") {
      parameters.blendFunc = [esm_default.SRC_ALPHA, esm_default.DST_ALPHA];
      parameters.blendEquation = esm_default.FUNC_ADD;
    } else if (layerBlending === "subtractive") {
      parameters.blendFunc = [esm_default.ONE, esm_default.ONE_MINUS_DST_COLOR, esm_default.SRC_ALPHA, esm_default.DST_ALPHA];
      parameters.blendEquation = [esm_default.FUNC_SUBTRACT, esm_default.FUNC_ADD];
    }
  ...
  async function mapInstantiation({
    ...
    const baseUrl2 = `${credentials2.mapsUrl}/${connection}/${type}`;
    ...
    const url = `${baseUrl2}?${encodedParameters.join("&")}`;
    const {
      accessToken
    } = credentials2;
    const errorContext = {
  ...
  function getUrlFromMetadata(metadata, format2) {
    const m = metadata[format2];
    if (m && !m.error && m.url) {
      return m.url[0];
    }
    return null;
  ...
  function checkFetchLayerDataParameters({
    ...
    assert(credentials2.apiVersion === API_VERSIONS.V3, "Method only available for v3");
    assert(credentials2.apiBaseUrl, "Must define apiBaseUrl");
    assert(credentials2.accessToken, "Must define an accessToken");
    if (columns) {
      assert(COLUMNS_SUPPORT.includes(type), `The columns parameter is not supported by type ${type}`);
    }
    if (geoColumn) {
      assert(GEO_COLUMN_SUPPORT.includes(type), `The geoColumn parameter is not supported by type ${type}`);
    } else {
  ...
  async function _fetchDataUrl({
    ...
    if (format2) {
      mapFormat = format2;
      url = getUrlFromMetadata(metadata, format2);
      assert(url, `Format ${format2} not available`);
    } else {
    ...
    if (format2 === FORMATS.TILEJSON && formatTiles) {
      import_core10.log.assert(Object.values(TILE_FORMATS).includes(formatTiles), `Invalid value for formatTiles: ${formatTiles}. Use value from TILE_FORMATS`);
  ...
  async function _fetchTilestats(attribute, dataset, accessToken, credentials2) {
    ...
    let baseUrl2 = `${statsUrl}/${connection}/`;
    if (type === MAP_TYPES.QUERY) {
      baseUrl2 += attribute;
    } else {
      baseUrl2 += `${source}/${attribute}`;
    }
    const errorContext = {
  ...
  async function fillInMapDatasets({
    ...
    const promises = datasets.map((dataset) => _fetchMapDataset(dataset, token, credentials2, clientId, headers));
  ...
  async function fillInTileStats({
    ...
    const promises = filteredAttributes.map(({
      attribute,
      dataset
    }) => _fetchTilestats(attribute, dataset, token, credentials2));
    return await Promise.all(promises);
  }
  async function fetchMap({
    ...
    if (autoRefresh) {
      const intervalId = setInterval(async () => {
        const changed = await fillInMapDatasets(map2, clientId, localCreds, headers);
    ...
    await fillInMapDatasets(map2, clientId, localCreds, headers);
    await fillInTileStats(map2, localCreds);
    const out = {
      ...parseMap(map2),
      ...{
        stopAutoRefresh
  ...
  var CartoLayer = class extends import_core11.CompositeLayer {
    initializeState() {
      this.state = {
        data: null,
        apiVersion: null
    ...
    _checkProps(props) {
      ...
      import_core11.log.assert(Object.values(API_VERSIONS).includes(apiVersion), `Invalid apiVersion ${apiVersion}. Use API_VERSIONS enum.`);
      if (apiVersion === API_VERSIONS.V1 || apiVersion === API_VERSIONS.V2) {
        import_core11.log.assert(type === MAP_TYPES.QUERY || type === MAP_TYPES.TILESET, `Invalid type ${type}. Use type MAP_TYPES.QUERY or MAP_TYPES.TILESET for apiVersion ${apiVersion}`);
        import_core11.log.assert(!connection, `Connection prop is not supported for apiVersion ${apiVersion}`);
        import_core11.log.assert(!geoColumn, `geoColumn prop is not supported for apiVersion ${apiVersion}`);
        import_core11.log.assert(!columns, `columns prop is not supported for apiVersion ${apiVersion}`);
      } else if (apiVersion === API_VERSIONS.V3) {
        import_core11.log.assert(connection, "Missing mandatory connection parameter");
        import_core11.log.assert(Object.values(MAP_TYPES).includes(type), `Invalid type ${type}. Use MAP_TYPES enum.`);
        if (!COLUMNS_SUPPORT.includes(type)) {
          import_core11.log.assert(!columns, `columns prop is only supported for types: ${COLUMNS_SUPPORT.join()}`);
        }
        if (!GEO_COLUMN_SUPPORT.includes(type)) {
          import_core11.log.assert(!geoColumn, `geoColumn prop is only supported for types: ${GEO_COLUMN_SUPPORT.join()}`);
        }
        if (columns) {
          import_core11.log.assert(Array.isArray(columns), "columns prop must be an Array");
        }
      }
    }
    updateState({
    ...
    _getSubLayerAndProps() {
      ...
      if (apiVersion === API_VERSIONS.V1 || apiVersion === API_VERSIONS.V2) {
        return [import_geo_layers8.MVTLayer, props];
      }
  ...
  __publicField(CartoLayer, "layerName", "CartoLayer");
  __publicField(CartoLayer, "defaultProps", defaultProps9);
  ...
  function getAttrValue(attr, d) {
    assert3(typeof d === "object", 'Expected "data" to be an object');
    assert3(ALLOWED_ATTR_TYPES.includes(typeof attr), 'Expected "attr" to be a function or string');
  ...
  function getPalette(name, numCategories) {
    ...
    assert3(palette, `Palette "${name}" not found. Expected a CARTOColors string`);
  ...
  function hexToRgb(hex2) {
    ...
    assert3(result, `Hexadecimal color "${hex2}" was not parsed correctly`);
  ...
  function colorBins({
    ...
    assert3(Array.isArray(domain), 'Expected "domain" to be an array of numbers');
  ...
  function colorCategories({
    ...
    assert3(Array.isArray(domain), 'Expected "domain" to be an array of numbers or strings');
  ...
  if (!import_layers5.GeoJsonLayer) {
