...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('minimist'), require('rw'), require('@mapbox/unitbezier'), require('@mapbox/jsonlint-lines-primitives')) :
    typeof define === 'function' && define.amd ? define(['minimist', 'rw', '@mapbox/unitbezier', '@mapbox/jsonlint-lines-primitives'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.minimist, global.rw, global.UnitBezier, global.jsonlint));
})(this, (function (minimist, rw, UnitBezier, jsonlint) { 'use strict';
